...
var MenuFR = function(_a, ref) {
  ...
  var providerValue = import_react.default.useMemo(function() {
    return { closeOnClick, menuItemStyles, renderExpandIcon };
...
var SubMenuContentFR = function(_a, ref) {
  ...
  return import_react.default.createElement(
    ...
    __assign({ "data-testid": "".concat(menuClasses.subMenuContent, "-test-id"), ref, firstLevel, collapsed, open, openWhenCollapsed }, rest),
    import_react.default.createElement(StyledUl, null, children)
  );
};
...
var SubMenuFR = function(_a, ref) {
  ...
  var _k = import_react.default.useState(!!defaultOpen), open = _k[0], setOpen = _k[1];
  var _l = import_react.default.useState(!!defaultOpen), openDefault = _l[0], setOpenDefault = _l[1];
  var _m = import_react.default.useState(false), openWhenCollapsed = _m[0], setOpenWhenCollapsed = _m[1];
  var _o = import_react.default.useState(), popperInstance = _o[0], setPopperInstance = _o[1];
  var childNodes = import_react.default.Children.toArray(children).filter(Boolean);
  var anchorRef = import_react.default.useRef(null);
  var SubMenuContentRef = import_react.default.useRef(null);
  ...
  import_react.default.useEffect(function() {
    var handleDocumentClick = function(event) {
      var _a2, _b2, _c2;
      if (!openWhenCollapsed && ((_a2 = anchorRef.current) === null || _a2 === void 0 ? void 0 : _a2.contains(event.target)))
        setOpenWhenCollapsed(true);
      else if (closeOnClick && !((_b2 = event.target.closest(".menu-item")) === null || _b2 === void 0 ? void 0 : _b2.classList.contains("sub-menu")) || !((_c2 = SubMenuContentRef.current) === null || _c2 === void 0 ? void 0 : _c2.contains(event.target)) && openWhenCollapsed) {
        setOpenWhenCollapsed(false);
      }
    };
  ...
  return import_react.default.createElement(
    StyledSubMenu,
    { ref, className: classnames(menuClasses.menuItemRoot, menuClasses.subMenuRoot, (_b = {}, _b[menuClasses.active] = active, _b), (_c = {}, _c[menuClasses.disabled] = disabled, _c), (_d = {}, _d[menuClasses.open] = openSubmenu !== null && openSubmenu !== void 0 ? openSubmenu : open, _d), className), menuItemStyles: getSubMenuItemStyles("root"), rootStyles },
    import_react.default.createElement(
      StyledMenuButton,
      __assign({ "data-testid": "".concat(menuClasses.button, "-test-id"), ref: anchorRef, rtl, title, level, collapsed, className: menuClasses.button, onClick: handleSlideToggle, disabled, active, rootStyles: getSubMenuItemStyles("button") }, rest),
      icon && import_react.default.createElement(StyledMenuIcon, { rtl, className: menuClasses.icon, rootStyles: getSubMenuItemStyles("icon") }, icon),
      prefix2 && import_react.default.createElement(StyledMenuPrefix, { collapsed, transitionDuration, firstLevel: level === 0, className: menuClasses.prefix, rtl, rootStyles: getSubMenuItemStyles("prefix") }, prefix2),
      import_react.default.createElement(StyledMenuLabel, { className: menuClasses.label, rootStyles: getSubMenuItemStyles("label") }, label),
      suffix && import_react.default.createElement(StyledMenuSuffix, { collapsed, transitionDuration, firstLevel: level === 0, className: menuClasses.suffix, rootStyles: getSubMenuItemStyles("suffix") }, suffix),
      import_react.default.createElement(StyledExpandIconWrapper, { rtl, className: menuClasses.SubMenuExpandIcon, collapsed, level, rootStyles: getSubMenuItemStyles("SubMenuExpandIcon") }, renderExpandIcon ? renderExpandIcon({
        level,
        disabled,
        active,
    ...
    import_react.default.createElement(SubMenuContent, { ref: SubMenuContentRef, openWhenCollapsed, open: openSubmenu !== null && openSubmenu !== void 0 ? openSubmenu : open, firstLevel: level === 0, collapsed, defaultOpen: openDefault, className: menuClasses.subMenuContent, rootStyles: getSubMenuItemStyles("subMenuContent") }, childNodes.map(function(node2) {
...
var MenuItemFR = function(_a, ref) {
  ...
  var routerRef = import_react.default.useRef();
  var handleClick = function(event) {
    var _a2;
    (_a2 = routerRef.current) === null || _a2 === void 0 ? void 0 : _a2.click();
    onClick === null || onClick === void 0 ? void 0 : onClick(event);
  };
  ...
  return import_react.default.createElement(
    StyledMenuItem,
    { ref, className: classnames(menuClasses.menuItemRoot, (_b = {}, _b[menuClasses.active] = active, _b), (_c = {}, _c[menuClasses.disabled] = disabled, _c), className), menuItemStyles: getMenuItemStyles("root"), rootStyles },
    import_react.default.createElement(
      StyledMenuButton,
      __assign({ className: menuClasses.button, "data-testid": "".concat(menuClasses.button, "-test-id"), level, collapsed, rtl, disabled, active, onClick: handleClick, rootStyles: getMenuItemStyles("button") }, rest),
      icon && import_react.default.createElement(StyledMenuIcon, { rtl, className: menuClasses.icon, rootStyles: getMenuItemStyles("icon") }, icon),
      prefix2 && import_react.default.createElement(StyledMenuPrefix, { collapsed, transitionDuration, firstLevel: level === 0, className: menuClasses.prefix, rtl, rootStyles: getMenuItemStyles("prefix") }, prefix2),
      import_react.default.createElement(StyledMenuLabel, { className: menuClasses.label, rootStyles: getMenuItemStyles("label") }, children),
      suffix && import_react.default.createElement(StyledMenuSuffix, { collapsed, transitionDuration, firstLevel: level === 0, className: menuClasses.suffix, rootStyles: getMenuItemStyles("suffix") }, suffix)
    ),
    routerLink && import_react.default.createElement(StyledRouterLinkWrapper, null, import_react.default.cloneElement(routerLink, { ref: routerRef }))
  );
};
